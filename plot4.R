...
with(power_data,{
  plot(coltime,power_data$Global_active_power, type="l", xlab= "",ylab= "Global Active Power")
  plot(coltime, power_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
  ...
  plot(coltime, power_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
})
dev.off()
