...
with(Nsub_data,{
  plot(Nsub_data$coltime,Nsub_data$Global_active_power, type="l", xlab= "",ylab= "Global Active Power")
  plot(Nsub_data$coltime, Nsub_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
  ...
  plot(Nsub_data$coltime, Nsub_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
})
dev.off()